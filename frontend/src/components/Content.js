            ...
            <div className="container-fluid" style={{ backgroundColor: "#EEE5F9" }}>
                ...
                <div className="row">
                    <div className="col-5 ms-5">
                        ...
                        <div className="mt-2">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.444093308443!2d106.62348197481903!3d10.85378815776246!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752b6c59ba4c97%3A0x535e784068f1558b!2zVHLGsOG7nW5nIENhbyDEkeG6s25nIEZQVCBQb2x5dGVjaG5pYw!5e0!3m2!1svi!2s!4v1697986840394!5m2!1svi!2s" width="610" height="295" style={{ borderRadius: "10px" }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                                    ...
                                    <div className="card-body p-3">
                                        <div className="form-group">
                                            <div className="input-group mb-2">
                                                ...
                                                <input type="text" className="form-control" id="nombre" name="nombre" placeholder="Họ Tên" required />
                                            </div>
                                        </div>
                                        <div className="form-group">
                                            <div className="input-group mb-2">
