                    ...
                    <div className="collapse navbar-collapse row m-auto" id="navbarNavDropdown">
                        <ul className="navbar-nav col-lg-12 col-4 ">
                            ...
                            <form className="d-flex" onSubmit={handleSubmit}>
                                ...
                                <input value={inputValue} onChange={handleInputChange} className="form-control me-2 col-ms-12" list="datalistOptions" id="exampleDataList" placeholder="Type to search..." style={{ width: "350px" }} />
