                ...
                <div className="card-body">
                    <div className="">
                        ...
                        <div className="form-group">
                            <input type="number" className="form-control mb-1" id="exampleFormControlInput1" placeholder="Từ" />
                            <input type="number" className="form-control" id="exampleFormControlInput2" placeholder="Đến" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="card border-1 mb-2">
                <div className="card-body">
                    <div className="">
                        ...
                        <div className="form-group">
                            <input type="time" className="form-control mb-1" id="exampleFormControlInput1" placeholder="Từ" />
                            <input type="time" className="form-control" id="exampleFormControlInput2" placeholder="Đến" />
                        </div>
                    </div>
                </div>
            </div>
