                ...
                <div className="row">
                    <div className="card border border-2 col-md-8">
                        ...
                        <div className="row mt-2 h6">
                            ...
                            <label className="form-label col-md-4 mb-3">Dự kiến check-in: <span>10/12/2023</span></label>
                            <label className="form-label col-md-4 mb-3">Dự kiến số ngày: <span>3</span></label>
                            <hr />
                        </div>
                    </div>
