    ...
    return (
        <Box sx={{ display: 'flex' }}>
                ...
                <List>
                    ...
                    >
                        ...
                        >
                            ...
                            <ListItemText primary='Thông tin đối tác' sx={{ opacity: open ? 1 : 0 }} />
                        </ListItemButton>
                    </ListItem>
                </List>
                {/* <List>
          <ListItem
            ...
            sx={{ display: "block" }}
            onClick={() => {
              navigate("/partner/hotel-manager");
            }}
          >
            <ListItemButton
              sx={{
                ...
                <List>
                    ...
                    >
                        ...
                        >
                            ...
                            <ListItemText primary='Quản lý phòng' sx={{ opacity: open ? 1 : 0 }} />
                        </ListItemButton>
                    </ListItem>
                </List>
                <List>
                    ...
                    >
                        ...
                        >
                            ...
                            <ListItemText primary='Đơn chờ duyệt' sx={{ opacity: open ? 1 : 0 }} />
                        </ListItemButton>
                    </ListItem>
                </List>
                <List>
                ...
                <List>
                    ...
                    >
                        ...
                        >
                            ...
                            <ListItemText primary='View page' sx={{ opacity: open ? 1 : 0 }} />
                        </ListItemButton>
                    </ListItem>
                </List>
                <Divider />
